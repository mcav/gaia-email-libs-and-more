...
var $log = require('rdcommon/log'),
    ...
    $mailslice = require('src/mailslice'),
    $cronsync = require('src/cronsync'),
    $searchfilter = require('src/searchfilter'),
    $sync = require('src/syncbase'),
    $imapfolder = require('src/imap/folder'),
    $imapjobs = require('src/imap/jobs'),
    $pop3jobs = require('src/pop3/jobs'),
    $util = require('src/util'),
    $errbackoff = require('src/errbackoff'),
    $smtpacct = require('src/smtp/account'),
    $router = require('src/worker-router'),
