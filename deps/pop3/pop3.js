define(['module', 'exports', 'rdcommon/log', 'tcp-socket', 'md5',
        './transport', 'mimeparser', 'src/imap/imapchew',
        'src/syncbase',
        'mimefuncs',
        './mime_mapper', 'src/allback'],
function(module, exports, log, tcpSocket, md5,
  ...
  Pop3Client.prototype.parseMime = function(mimeContent, isSnippet, number) {
    ...
    var estSize = number && this.idToSize[number] ||
          (mp.node.content && mp.node.content.length) || 0;
    var content;
