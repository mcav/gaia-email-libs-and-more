 ...
 * largely compatible with the real implementation, except for
 * bufferedAmount and other buffering semantics (because we can't
 * synchronously retrieve those values).
 *
...
define(function(require, exports, module) {
  ...
  var router = require('src/worker-router');
