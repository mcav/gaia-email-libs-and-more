...
define([
  ...
  BrowserBox.prototype.login = function(creds, cb) {
    ...
    // grabbed the capabilities, so we can exclude that from the
    // reasons we'd see LOGINDISABLED. If it still says LOGINDISABLED
    // at this point, the server may be down for maintenance.
